        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="text-center text-bold">ຟອມແກ້ໄຂຂໍ້ມູນນັກສຶກສາ</h1>
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">ການແກ້ໄຂຂໍ້ມູນນັກສຶກສາ</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="password" class="form-control"
                                                        id="exampleInputPassword1" value="<?php echo $row['password']?>"
                                                        required placeholder="ນາມສະກຸນ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="f_name" class="form-control"
                                                        id="exampleInputEmail1" value="<?php echo $row['f_name']?>"
                                                        required placeholder="ຊື່ພໍ່">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="f_phone" class="form-control"
                                                        id="exampleInputPassword1" value="<?php echo $row['f_phone']?>"
                                                        required placeholder="ເບີໂທພໍ່">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="m_name" class="form-control"
                                                        id="exampleInputEmail1" value="<?php echo $row['m_name']?>"
                                                        required placeholder="ເບີໂທແມ່">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="m_phone" class="form-control"
                                                        id="exampleInputPassword1" value="<?php echo $row['m_phone']?>"
                                                        required placeholder="ເບີໂທແມ່">
                                                </div>
                                            </div>
