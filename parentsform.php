                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="f_name" class="form-control"
                                                    id="exampleInputEmail1" required placeholder="ຊື່ພໍ່">
                                            </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">ເບີໂທພໍ່</label>
                                                <input type="text" name="f_phone" class="form-control"
                                                    id="exampleInputPassword1" required placeholder="ເບີໂທພໍ່">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="m_name" class="form-control"
                                                    id="exampleInputEmail1" required placeholder="ຊື່ແມ່">
                                            </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">ເບີໂທແມ່</label>
                                                <input type="text" name="m_phone" class="form-control"
                                                    id="exampleInputPassword1" required placeholder="ເບີໂທແມ່">
                                            </div>
                                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="editparents.php?id=<?php echo $row['id']?>"
